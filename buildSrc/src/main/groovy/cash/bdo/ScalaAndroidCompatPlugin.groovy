...
//        configureScaladoc(project, mainSourceSet, mainScalaCompile)
    ...
    private boolean resolveScalaSrcDirsToAndroidSourceSetsClosure(Project project, sourceSet, boolean evaluated) {
        LOG.info "$NAME_PLUGIN ---> [resolveScalaSrcDirsToAndroidSourceSetsClosure]sourceSet.name:${sourceSet.name}, displayName:${sourceSet.name}"
        ...
        final displayName = sourceSet.name //(String) InvokerHelper.invokeMethod(sourceSet, "getDisplayName", null)
